...
function redFace (){
    var ginElem = document.getElementById ("drink");
    ginElem.style.color = "red";
    ginElem.style.fontSize = "30px";
}
...
function showPrice (){
    var oreoElem = document.getElementById ("price");
    oreoElem.innerHTML = "$5.95";
}
...
randomQuote.addEventListener ("click", randomThing)

function randomThing (){
    var qElem = document.getElementById("displayQuotes");
    qElem.innerHTML = quotes;
}
